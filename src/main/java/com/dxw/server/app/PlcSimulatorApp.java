 ...
 * @author pronics3
 */
public class PlcSimulatorApp {

    private PlcSimulatorApp() throws ServiceException {
        init();
    }
    ...
    private void start() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlcSimulatorApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
